  ...
  void drawRobot(void)
{
    ...
    glTranslatef (1.0, 0.0, 0.0);
    glPushMatrix();
    //glScalef (1.0, 0.4, 3.0);
    glScalef(0.4, 1.0, 3.0);    // aufrechte hufte
    glutWireCube (1.0);
    glPopMatrix();
    glPopMatrix();
    ...
    glRotatef ((GLfloat) oberschenkel, 0.0, 0.0, 1.0);
    ...
    // unterschenkel
    glTranslatef (2.0, 0.0, 0.0);
    glRotatef ((GLfloat) unterschenkel, 0.0, 0.0, 1.0);
    glTranslatef (2.0, 0.0, 0.0);
    glPushMatrix();
    glScalef (4.0, 0.4, 1.0);
    glutWireCube (1.0);
    ...
    //added sohle
    glTranslatef (2.0, 0.0, 0.0);
    glRotatef ((GLfloat) sohle, 0.0, 0.0, 1.0);
    glTranslatef (1.0, 0.0, 0.0);
    glPushMatrix();
    ...
    // oberschenkel 2
    glPushMatrix();
    glTranslatef (0.0, -0.5, -1.0);  // x, y ,z
    glRotatef ((GLfloat) oberschenkel2, 0.0, 0.0, 1.0);
    glTranslatef (2.0, 0.0, 0.0);
    glPushMatrix();
    glScalef (4.0, 0.4, 1.0);
    glutWireCube (1.0);
    ...
    // unterschenkel 2
    glTranslatef (2.0, 0.0, 0.0);
    glRotatef ((GLfloat) unterschenkel2, 0.0, 0.0, 1.0);
    glTranslatef (2.0, 0.0, 0.0);
    glPushMatrix();
    glScalef (4.0, 0.4, 1.0);
    glutWireCube (1.0);
    ...
    //added sohle 2
    glTranslatef (2.0, 0.0, 0.0);
    glRotatef ((GLfloat) sohle2, 0.0, 0.0, 1.0);
    glTranslatef (1.0, 0.0, 0.0);
    glPushMatrix();
    glScalef (2.0, 0.4, 1.0);
    glutWireCube (1.0);
...
void drawAxes()
{
    if (toggleAxes) //Achsen mit 'a' schalten
    {
        ...
        //  Label axes
        glColor3f(1.0,1.0,1.0); //Farbe, weis
